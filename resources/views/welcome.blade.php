...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="#intro" class="scrollto"><img src="{{ asset('landing/img/logo.png') }} " alt="" title=""></a>
      </div>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0">SISTEM INFORMASI MANAJEMEN<br><span>SATU DATA</span> PROVINSI NUSA TENGGARA BARAT</h1>
      <p class="mb-4 pb-0"><i>#Bantu Kami Mencatat Indonesia</i></p>
      <a href="https://www.youtube.com/watch?v=2q7H7n4sLm0" class="venobox play-btn mb-4" data-vbtype="video"
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <img src="{{ asset('landing/img/logo.png') }} " alt="TheEvenet">
